(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.utf-listing-carousel-itemA').owlCarousel({
            autoPlay: true,
            navigation: true,
            slideSpeed: 800,
			slidesToShow: 5,
...
(function($) {
    ...
    $(document).on('click','.arrowRight',function (){
        $('#webTabs').find('.hiddenweb1').css('display','none');
        $('#webTabs').find('.hiddenweb2').css('display','block');
    });
